...
import useSideDrawer from "@app/pages/withdrawal/hook/useSideDrawer";

const WithdrawalDataTable: FC<depositDataTableProps> = (props) => {
    ...
    return (
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <FormProvider {...methods}>
                <SideDrawer formId="withdrawalForm" isDrawerClose={isDrawerClose} setIsDrawerClose={setIsDrawerClose} isEdit={isEdit} isStatusPending={isStatusPending} masterData={masterData} />
            </FormProvider>
        </div>
    )
}
