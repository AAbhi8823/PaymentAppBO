...
import { useAddBankInformationMutation } from "@app/store/services/depositBankAccountApi";
...
const BankAccountForm: FC<bankAccountFormProps> = (props) => {
    ...
    const handleAddNewBank = async (fieldValue: FieldValues) => {
        const reqBody = {
            ...
            total_deposit_amount: fieldValue.totalAmount,
            min_deposit_limit: fieldValue?.minDepositLimit,
            max_deposit_limit: fieldValue?.maxDepositLimit,
            // hard coded payload
            bank_url: "https://netbanking.hdfcbank.com/netbanking/",
            username: "someone_2345",
            account_holder_name: "akhter"
        }
        ...
        try {
            ...
            if (response?.data?.resData?.status) {
                ...
                setUserDetail(response.data.resData?.data);
                refetch();
                return;
            }
        ...
        <div className="my-10">
            ...
            <form onSubmit={handleSubmit(handleAddNewBank)}>
                ...
                <div className="flex gap-2 mt-6 md:mt-3">
                    ...
                    <Button variant="secondary" onClick={handleReset} type="reset">Clear</Button>
                </div>
            </form>

            <Model isHidden={isHidden} setIsHidden={setIsHidden} title="Login Info">
